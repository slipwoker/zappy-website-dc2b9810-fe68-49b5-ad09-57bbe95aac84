document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (!isNaN(minLength) && value.length > 0 && value.length < minLength) {
        errorMsg = fieldName.charAt(0).toUpperCase() + fieldName.slice(1) +
    ...
    const successMsg = form.querySelector('.form-success') || createFormMessage(form, 'success');
    const errorMsg2 = form.querySelector('.form-error-msg') || createFormMessage(form, 'error');
    ...
    fetch(action, {
      ...
      .catch(function (err) {
        errorMsg2.textContent = err.message || 'Something went wrong. Please try again later.';
  ...
  function showFieldError(field, message) {
    ...
    if (!errorEl) {
      ...
      errorEl.style.cssText =
        'display:block;color:#e53e3e;font-size:0.85em;margin-top:4px;';
  ...
  function clearFormErrors(form) {
    ...
    form.querySelectorAll('.field--valid').forEach(function (el) {
  ...
  function createFormMessage(form, type) {
    const el = document.createElement('div');
    el.className = type === 'success' ? 'form-success' : 'form-error-msg';
    el.setAttribute('role', type === 'success' ? 'status' : 'alert');
    el.style.cssText = type === 'success'
      ? 'display:none;padding:12px;background:#c6f6d5;color:#276749;border-radius:6px;margin-top:12px;'
      : 'display:none;padding:12px;background:#fed7d7;color:#9b2c2c;border-radius:6px;margin-top:12px;';
    form.appendChild(el);
    return el;
  }
  ...
  const animatableEls = document.querySelectorAll(OBSERVE_SELECTORS.join(','));

  if (animatableEls.length > 0) {
    const style = document.createElement('style');
    style.textContent = [
      '.fade-in, .scroll-animate, .animate-on-scroll, [data-animate] {',
      '  opacity: 0;',
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'dc2b9810-fe68-49b5-ad09-57bbe95aac84',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'dc2b9810-fe68-49b5-ad09-57bbe95aac84';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'dc2b9810-fe68-49b5-ad09-57bbe95aac84';
